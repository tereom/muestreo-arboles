...
```{r, echo=FALSE, fig.height=4, fig.width=4, fig.align='center',message=FALSE, warning=FALSE}
...
```{r, echo=FALSE, fig.height=5, fig.width=7, fig.align='center',message=FALSE,warning=FALSE}
...
```{r, echo=FALSE, fig.height=5, fig.width=5, fig.align='center',message=FALSE,warning=FALSE}
ggplot(arbolado_congs) + 
  geom_polygon(data = edo_df, colour='darkgray', fill = "darkgray", alpha = 0.4,
               aes(x = long, y = lat, group = group)) + 
...
```{r, echo=FALSE, fig.height=8.5, fig.width=6, fig.align='center',message=FALSE,warning=FALSE}
